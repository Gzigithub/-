...
def f3_data(driver, num):
    ...
    if num != int(cnum):
        ...
        driver.get(url)
        try:
            locator = (By.XPATH, "//div[@class='pageright']/ul/li[1]/a[not(contains(string(), '%s'))]" % val)
            WebDriverWait(driver, 10).until(EC.presence_of_element_located(locator))
        except:
            driver.refresh()
            locator = (By.XPATH, "//div[@class='pageright']/ul/li[1]/a[not(contains(string(), '%s'))]" % val)
...
def f3(driver, url):
    ...
    if 'http://wsjj.njztb.cn/njcg/' in url:
        ...
        # driver.get(url)
        locator = (By.XPATH, "//table[@class='yygl'] | //div[@id='header'] | //*[@id='plugin']")
...
if __name__=='__main__':
    ...
    # driver = webdriver.Chrome()
    # url = "http://wsjj.njztb.cn/njcg/ZFCGZtbMis_NeiJiang/Pages/GongGaoChaKan/GongGao_List.aspx?ViewType=ZGCJGG&QuYu=SBJ"
    # driver.get(url)
    # df = f2(driver)
    # print(df)
    #
