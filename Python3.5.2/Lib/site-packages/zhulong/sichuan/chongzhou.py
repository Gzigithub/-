...
data = [
    ...
    ["gcjs_jieguo_gg", "https://www.cdggzy.com/chongzhou/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["gcjs_biangen_gg", "https://www.cdggzy.com/chongzhou/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],

    ["gcjs_zhongbiaohx_gg", "https://www.cdggzy.com/chongzhou/site/JSGC/List.aspx",
    ...
    ["zfcg_biangen_gg", "https://www.cdggzy.com/chongzhou/site/Notice/ZFCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_jieguo_gg", "https://www.cdggzy.com/chongzhou/site/Notice/ZFCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],

    ["zfcg_zhaobiao_wsjj_gg", "https://www.cdggzy.com/chongzhou/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_jieguo_wsjj_gg", "https://www.cdggzy.com/chongzhou/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_liubiao_wsjj_gg", "https://www.cdggzy.com/chongzhou/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],

    ["zfcg_jieguobiangen_wsjj_gg", "https://www.cdggzy.com/chongzhou/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_4(f1), click_link_4(f2)],
    #
    ["zfcg_zhaobiao_ddcg_gg", "https://www.cdggzy.com/chongzhou/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_jieguo_ddcg_gg", "https://www.cdggzy.com/chongzhou/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],
...
if __name__=='__main__':
    ...
    # driver=webdriver.Chrome()
    # url="https://www.cdggzy.com/chongzhou/site/JSGC/List.aspx"
    # driver.get(url)
    # df = gcjs_jieguo(f2)(driver)
    # print(df)
    # driver=webdriver.Chrome()
    # url="https://www.cdggzy.com/chongzhou/site/JSGC/List.aspx"
    # driver.get(url)
    # for i in range(1, 9):
    #     df=gcjs_jieguo(f1)(driver, i)
    #     print(df)
