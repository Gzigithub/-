...
def f3(driver, url):
    driver.get(url)
    locator = (By.XPATH, "//div[@class='row'] | //form[@id='form1']")
...
data = [
    ...
    ["gcjs_gg", "https://www.cdggzy.com/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["gcjs_biangen_gg", "https://www.cdggzy.com/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],

    ["gcjs_zhongbiaohx_gg", "https://www.cdggzy.com/site/JSGC/List.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_4(f1), click_link_4(f2)],

    ["gcjs_liubiaozhongzhi_gg", "https://www.cdggzy.com/site/JSGC/List.aspx",
    ...
    ["zfcg_biangen_gg", "https://www.cdggzy.com/site/Notice/ZFCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_jieguo_gg", "https://www.cdggzy.com/site/Notice/ZFCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],

    ["zfcg_zigeshencha_gg", "https://www.cdggzy.com/site/Notice/CprtsCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_fuheshencha_gg", "https://www.cdggzy.com/site/Notice/CprtsCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_gysdefen_gg", "https://www.cdggzy.com/site/Notice/CprtsCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],
    ...
    ["zfcg_baojia_pljz_gg", "https://www.cdggzy.com/site/Notice/PLJZ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_jieguo_pljz_gg", "https://www.cdggzy.com/site/Notice/PLJZ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],
    #
    ["zfcg_zhaobiao_wsjj_gg", "https://www.cdggzy.com/site/Notice/CprtsWSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_baojia_wsjj_gg", "https://www.cdggzy.com/site/Notice/CprtsWSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_jieguo_wsjj_gg", "https://www.cdggzy.com/site/Notice/CprtsWSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],
    #
    ["zfcg_zhongbiao_wsjj_gg", "https://www.cdggzy.com/site/Notice/CprtsWSJJ/NoticeListNew.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_biangen_wsjj_gg", "https://www.cdggzy.com/site/Notice/CprtsWSJJ/NoticeListNew.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],
    ...
    ["zfcg_baojia_rjcg_gg", "https://www.cdggzy.com/site/Notice/CprtsDDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_jieguo_rjcg_gg", "https://www.cdggzy.com/site/Notice/CprtsDDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],

    ["zfcg_jieguobiangen_rjcg_gg", "https://www.cdggzy.com/site/Notice/CprtsDDCG/NoticeList.aspx",
    ...
    ["zfcg_zhongbiao_ddcg_gg", "https://www.cdggzy.com/site/Notice/CprtsDDCGNewAdd/FurnitureDD/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_gglx_1(f1), click_gglx_1(f2)],

    ["zfcg_jieguobiangen_ddcg_gg", "https://www.cdggzy.com/site/Notice/CprtsDDCGNewAdd/FurnitureDD/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_gglx_2(f1), click_gglx_2(f2)],
    #
    ["zfcg_zishenjieguo_wscg_gg", "https://www.cdggzy.com/site/Notice/CprtsCompanyInfo/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    #
    ["zfcg_zhaobiao_qcqcg_gg", "https://www.cdggzy.com/site/Notice/QCQCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_biangen_qcqcg_gg", "https://www.cdggzy.com/site/Notice/QCQCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_jieguo_qcqcg_gg", "https://www.cdggzy.com/site/Notice/QCQCGXX/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],
    #
    ["zfcg_zhaobiao_qxwsjj_gg", "https://www.cdggzy.com/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_jieguo_qxwsjj_gg", "https://www.cdggzy.com/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_liubiao_qxwsjj_gg", "https://www.cdggzy.com/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],

    ["zfcg_jieguobiangen_qxwsjj_gg", "https://www.cdggzy.com/site/Notice/WSJJ/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_4(f1), click_link_4(f2)],
    #
    ["zfcg_zhaobiao_qxddcg_gg", "https://www.cdggzy.com/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_jieguo_qxddcg_gg", "https://www.cdggzy.com/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_liubiao_qxddcg_gg", "https://www.cdggzy.com/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],

    ["zfcg_jieguobiangen_qxddcg_gg", "https://www.cdggzy.com/site/Notice/DDCG/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_4(f1), click_link_4(f2)],
    #
    ["zfcg_zigeshencha_qx_gg", "https://www.cdggzy.com/site/Notice/Suppermsg/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_1(f1), click_link_1(f2)],

    ["zfcg_fuheshencha_qx_gg", "https://www.cdggzy.com/site/Notice/Suppermsg/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_2(f1), click_link_2(f2)],

    ["zfcg_gysdefen_qx_gg", "https://www.cdggzy.com/site/Notice/Suppermsg/NoticeList.aspx",
     ["name", "ggstart_time", "href", "info"], click_link_3(f1), click_link_3(f2)],

]


#2000页，现有线程和重启次数无法支持；可考虑增加线程数和重启数
def work(conp,**args):
    est_meta(conp,data=data,diqu="四川省成都市",**args)
    est_html(conp,f=f3,**args)

if __name__=='__main__':
    work(conp=["postgres","since2015","192.168.3.171","sichuan","chengdu"],pageloadtimeout=60,pageLoadStrategy="none")
    ...
    # driver.get(url)
    # df = click_gglx_1(f2)(driver)
    # print(df)
    # driver=webdriver.Chrome()
    # url="https://www.cdggzy.com/site/JSGC/List.aspx"
    # driver.get(url)
    # for i in range(2, 5):
    #     df = click_gglx_1(f1)(driver, i)
    #     print(df)
