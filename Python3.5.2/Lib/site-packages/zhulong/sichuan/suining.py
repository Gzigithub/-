...
if __name__=='__main__':
    work(conp=["postgres","since2015","192.168.3.171","sichuan","suining"],pageloadtimeout=60,pageLoadStrategy="none")


    # driver=webdriver.Chrome()
    # url = "http://jyzx.suining.gov.cn/JyWeb/JYXX/Index?type=%u4EA4%u6613%u4FE1%u606F&subtype=210&subtype2=210025"
    # driver.get(url)
    # df = f2(driver)
    # print(df)
    #
    # driver=webdriver.Chrome()
    # url = "http://jyzx.suining.gov.cn/JyWeb/JYXX/Index?type=%u4EA4%u6613%u4FE1%u606F&subtype=210&subtype2=210050"
    # driver.get(url)
    # for i in range(1, 16):
    #     df=f1(driver, i)
    #     print(df)
