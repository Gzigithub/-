...
def f3(driver, url):
    ...
    url = driver.current_url
    if 'http://wsjj.njztb.cn/njcg/' in url:
        # driver.switch_to_frame('TempIFrameID')
        ...
        # driver.get(url)
        locator = (By.XPATH, "//table[@class='yygl']")
...
if __name__=='__main__':
    work(conp=["postgres","since2015","192.168.3.171","sichuan","longchang"],pageloadtimeout=60,pageLoadStrategy="none")



    # driver = webdriver.Chrome()
    # url = "http://wsjj.njztb.cn/njcg/ZFCGZtbMis_NeiJiang/Pages/GongGaoChaKan/JJCJGongGao_List.aspx?ViewType=JJCGJJ&QuYu=LC"
    # driver.get(url)
    # df = f2(driver)
    # print(df)
    #
    # driver=webdriver.Chrome()
    # url = "http://wsjj.njztb.cn/njcg/ZFCGZtbMis_NeiJiang/Pages/GongGaoChaKan/JJGongGao_List.aspx?ViewType=JJGGBG&QuYu=LC"
    # driver.get(url)
    # # df = f3(driver, 'http://wsjj.njztb.cn/njcg/ZFCGZtbMis_NeiJiang/Pages/GongGaoChaKan/GongGao_Detail.aspx?GongGaoGuid=fa44b97e-ada5-4a3d-a847-015510c3391d%20%20%20%20&ViewType=JJCGJJ')
    # # print(df)
