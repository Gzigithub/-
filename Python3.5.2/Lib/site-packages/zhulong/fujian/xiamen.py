...
if __name__=='__main__':
    work(conp=["postgres","since2015","192.168.3.171","fujian","xiamen"],pageloadtimeout=60,pageLoadStrategy="none")

    # driver=webdriver.Chrome()
    # # url = "http://zyjy.xmas.gov.cn/XmUiForWeb2.0/govermentPurchase/getMongoGovPurchaseNoticePage.do/2"
    # url = "http://zyjy.xmas.gov.cn/XmUiForWeb2.0/project/getBltPage.do"
    # driver.get(url)
