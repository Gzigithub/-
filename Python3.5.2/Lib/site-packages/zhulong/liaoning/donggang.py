...
def f2(driver):
    for i in range(2,1000):
        locator = (By.XPATH, '//div[@class="abcde"]')
        WebDriverWait(driver, 20).until(EC.presence_of_element_located(locator))
        url = driver.current_url.split("&")[0] + "&Page=" + str(i)
        try:
            driver.get(url)
            locator = (By.XPATH,"//div[@class='zw']/ul/li")
...
if __name__ == "__main__":
    conp=["postgres", "since2015", "192.168.3.171", "liaoning", "donggang"]
    import sys
    arg=sys.argv
    if len(arg) >3:
