...
def f1(driver,num):
    ...
    for content in content_list:
        ...
        url = "http://ggggjy.gxgg.gov.cn" + content.xpath("./td[2]/a/@href")[0]
...
data =[
    ...
    ["gcjs_fangjianshizheng_zhaobiao_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001001/001001001/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_fangjianshizheng_biangeng_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001001/001001002/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_fangjianshizheng_kongzhijia_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001001/001001004/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_fangjianshizheng_zhongbiao_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001001/001001005/",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["zfcg_zhaobiao_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001004/001004001/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_biangeng_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001004/001004002/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_kongzhijia_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001004/001004005/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_zhongbiao_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001004/001004004/",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["gcjs_shuilijiaotong_zhaobiao_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001010/001010001/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_shuilijiaotong_biangeng_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001010/001010002/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_shuilijiaotong_kongzhijia_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001010/001010003/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["gcjs_shuilijiaotong_zhongbiaohx_gg",
     "http://ggggjy.gxgg.gov.cn/gxggzbw/jyxx/001010/001010004/",
     ["name", "ggstart_time", "href", "info"], f1, f2],
