...
data=[
        ...
        ["gcjs_ruwei_gg","http://www.jyggjy.cn/TPFront/jyxx/005002/005002004/?Paging=1",["name","ggstart_time","href","info"],f1,f2],
...
if __name__=="__main__":
    work(conp=["postgres","since2015","127.0.0.1","henan","jiyuan"])