...
def get_data():
    ...
    for w1 in ggtype.keys():
        for w2 in dztype.keys():
            ...
            tmp=["gcjs_%s_diqu%s"%(w1,dztype[w2]),href,["name","ggstart_time","href","info"],f1,f2]
            data.append(tmp)
    ...
    for w1 in ggtype.keys():
        for w2 in dztype.keys():
            ...
            tmp=["zfcg_%s_diqu%s"%(w1,dztype[w2]),href,["name","ggstart_time","href","info"],f1,f2]
            data.append(tmp)
    ...
    for w in dztype1.keys():
        ...
        tmp=["zfcg_gqita_diqu%s"%(dztype1[w]),href,["name","ggstart_time","href","info"],f1,f2]
        data.append(tmp)
    return data
...
if __name__=="__main__":
    work(conp=["postgres","since2015","127.0.0.1","henan","luoyang"])