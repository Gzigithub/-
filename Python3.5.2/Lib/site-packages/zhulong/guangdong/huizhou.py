...
def f1(driver,num):
    ...
    for tr in trs:
        ...
        return url;
            """%i)
        tmp=[a["title"],td.text.strip(),href]
        i+=1
        data.append(tmp)
...
data=[
        ...
        ["gcjs_biangen_gg","http://zyjy.huizhou.gov.cn/PublicServer/public/commonAnnouncement/listPage.html?businessType=2&announcementType=23",["name","ggstart_time","href","info"],f1,f2],
        ...
        ["zfcg_biangen_gg","http://zyjy.huizhou.gov.cn/PublicServer/public/commonAnnouncement/listPage.html?businessType=1&announcementType=11",["name","ggstart_time","href","info"],f1,f2],
