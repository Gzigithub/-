...
def f1(driver, num):
    ...
    for content in content_list:
        ...
        url = "http://ggzy.sqzwfw.gov.cn" + content.xpath("./td[2]/a/@href")[0]
...
def switch(driver, xmtype, ggtype):
    locator = (By.ID, 'index')
    WebDriverWait(driver, 20).until(EC.visibility_of_all_elements_located(locator))
    cnum = int(driver.find_element_by_xpath('//*[@id="index"]').text.split('/')[1])
...
data = [
    # 工程建设
    ["gcjs_yucai_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001001/001001007/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],
    ["gcjs_zhaobiao_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001001/001001001/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],
    ["gcjs_zishen_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001001/001001002/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],
    ["gcjs_kongzhijia_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001001/001001003/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],
    ["gcjs_zhongbiaohx_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001001/001001003/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],
    ["gcjs_zhongbiao_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001001/001001005/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],
    ["gcjs_pingdingfenli_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001001/001001006/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],
    # 交通
    #
    ["gcjs_jiaotong_zhaobiao_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001002/001002001/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],
    ["gcjs_jiaotong_zhongbiao_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001002/001002002/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],
    # # 水利
    #
    ["gcjs_shuili_zhaobiao_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001003/001003001/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],

    ["gcjs_shuili_zhongbiao_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001003/001003002/tradeInfo.html", ["name", "ggstart_time", "href", "info"],
     f1, f2],
    # # 政府采购
    #
    ["zfcg_zhaobiao_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001004/001004001/tradeInfo.html",
     ...
     f1, f2],
    ["zfcg_biangen_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001004/001004006/tradeInfo.html",
     ["name", "ggstart_time", "href", "info"],
     f1, f2],
    ...
    ["gcjs_qita_zhaobiao_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001007/001007001/tradeInfo.html",
     ["name", "ggstart_time", "href", "info"],
     f1, f2],
    ["gcjs_qita_zhongbiao_gg", "http://spzx.lyg.gov.cn/lygweb/jyxx/001007/001007002/tradeInfo.html",
     ["name", "ggstart_time", "href", "info"],
     f1, f2],
]
