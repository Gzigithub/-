...
data = [
    ...
    ["gcjs_zishen_gg", "http://ggzy.ycsp.gov.cn/front/showinfo/moreinfo_search.aspx?categoryNum=009&type=005",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ...
    ["zfcg_zhaobiao_gg", "http://ggzy.ycsp.gov.cn/front/showinfo/moreinfo_search.aspx?categoryNum=011&type=001",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ["zfcg_zhongbiao_gg", "http://ggzy.ycsp.gov.cn/front/showinfo/moreinfo_search.aspx?categoryNum=011&type=003",
     ["name", "ggstart_time", "href", "info"], f1, f2],
