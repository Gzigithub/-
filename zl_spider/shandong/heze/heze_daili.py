...
def work(conp, i=-1):
    data = [
        # ["gcjs_daili_gg","http://hzsggzyjy.gov.cn/cityInfoList.aspx?s=1&t=1",
        #  ["name", "ggstart_time", "href"]],

        ["qsydw_daili_gg", "http://hzsggzyjy.gov.cn/cityInfoList.aspx?s=1&t=5",
         ["name", "ggstart_time", "href"]],

        ["qita_daili_gg", "http://hzsggzyjy.gov.cn/cityInfoList.aspx?s=1&t=6",
         ["name", "ggstart_time", "href"]],
