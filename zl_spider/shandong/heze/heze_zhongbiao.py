...
def f1_data(driver, num, n):
    ...
    if num != int(cnum):
        ...
        # try:
        #     locator = (By.XPATH, "//*[@id='contentL{}']/div/ul/li[1]/a/h2[string()!='%s']".format(n) % val)
...
def work(conp, i=-1):
    data = [
        # ["gcjs_zhongbiao_gg","http://hzsggzyjy.gov.cn/cityInfoList.aspx?s=1&t=1",
        #  ["name", "ggstart_time", "href"]],

        ["qsydw_zhongbiao_gg", "http://hzsggzyjy.gov.cn/cityInfoList.aspx?s=1&t=5",
         ["name", "ggstart_time", "href"]],

        ["qita_zhongbiao_gg", "http://hzsggzyjy.gov.cn/cityInfoList.aspx?s=1&t=6",
         ["name", "ggstart_time", "href"]],
