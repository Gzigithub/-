...
def work(conp, i=-1):
    data = [
        # ["gcjs_yanshou_gg","http://hzsggzyjy.gov.cn/cityInfoList.aspx?s=1&t=1",
        #  ["name", "ggstart_time", "href"]],

        ["gcjs_yanshou_gg", "http://hzsggzyjy.gov.cn/cityInfoList.aspx?s=1&t=5",
         ["name", "ggstart_time", "href"]],

        ["qita_yanshou_gg", "http://hzsggzyjy.gov.cn/cityInfoList.aspx?s=1&t=6",
         ["name", "ggstart_time", "href"]],
