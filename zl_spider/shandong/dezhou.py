...
def work(conp, i=-1):
    data = [
        ...
        ["gcjs_biangeng_gg", "http://www.dzzyjy.gov.cn/TPFront/xmxx/004001/004001002/004001002001/?Paging=1",
         ["name", "ggstart_time", "href"]],
        ["gcjs_zhongbiaohouxuanren_gg", "http://www.dzzyjy.gov.cn/TPFront/xmxx/004001/004001008/004001008001/",
         ["name", "ggstart_time", "href"]],
...
if __name__ == '__main__':
    conp=["postgres","since2015","192.168.3.171","shandong","dezhou"]

    work(conp=conp)

    # driver=webdriver.Chrome()
    # url="http://www.dzzyjy.gov.cn/TPFront/xmxx/004001/004001005/004001005001/?Paging=1"
    # driver.get(url)
    # # df = f2(driver)
    # # print(df)
    # for i in range(1, 10):
