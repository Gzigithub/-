...
data = [
    ...
    ["gcjs_gg", "http://zw.hainan.gov.cn/ggzy/ggzy/jsqtgg/index.jhtml",
     ["name", "ggstart_time", "href", "info"], f1, f2],
    ...
    ["zfcg_gg", "http://zw.hainan.gov.cn/ggzy/ggzy/zfcgqtgg/index.jhtml",
     ["name", "ggstart_time", "href", "info"], f1, f2],

    ["ylcg_gg", "http://zw.hainan.gov.cn/ggzy/ggzy/yygg/index.jhtml",
     ["name", "ggstart_time", "href", "info"], f1, f2],
...
def work(conp):
    gg_meta(conp,data=data,diqu="海南省海南市")
...
if __name__ == '__main__':
    conp=["postgres","since2015","192.168.3.171","hainan","hainan"]
